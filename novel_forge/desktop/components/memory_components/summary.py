...
Auto-generated in the M3.8 split. Contains summary.py classes.
"""
...
class MemorySummaryPanel(Surface):
    """Panel displaying chapter/volume summary content."""
    ...
    def _build_ui(self) -> None:
        ...
        self._title_label.setObjectName("memoryMeta")
        layout.addWidget(self._title_label)

        self._content_label = QLabel("暂无摘要数据")
        self._content_label.setObjectName("memoryHint")
    ...
    def set_content(self, content: str) -> None:
        self._content_label.setText(content if content else "暂无摘要数据")
