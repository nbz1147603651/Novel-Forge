...
Auto-generated in the M3.8 split. Contains chips.py classes.
"""
...
class MemoryChip(QPushButton):
    """Compact chip for motif/category display with click support."""
