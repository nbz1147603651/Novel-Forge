"""Memory module UI components for the desktop application."""
...
from novel_forge.desktop.components.memory_components.badges import MemoryBadge
from novel_forge.desktop.components.memory_components.chips import MemoryChip
from novel_forge.desktop.components.memory_components.context import ContextOverviewCard
from novel_forge.desktop.components.memory_components.guidance import MemoryGuidanceCard
from novel_forge.desktop.components.memory_components.health import MemoryHealthIndicator
from novel_forge.desktop.components.memory_components.motifs import MemoryMotifCard
from novel_forge.desktop.components.memory_components.outline_tracker import (
    OutlineTrackerBadge,
    OutlineTrackerPanel,
)
from novel_forge.desktop.components.memory_components.suggestions import MemorySuggestionCard
from novel_forge.desktop.components.memory_components.summary import MemorySummaryPanel
from novel_forge.desktop.components.memory_components.unified import UnifiedMemoryPanel
...
__all__ = [
    ...
    "_STATE_INHERIT_TYPES",
    "_clip_issue_text",
    "_issue_display_summary",
    "_issue_signature",
    "_issue_value_text",
    "_memory_inset_card",
    "_stabilize_memory_surface",
]
