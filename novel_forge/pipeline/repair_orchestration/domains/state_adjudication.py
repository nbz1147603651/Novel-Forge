"""State-adjudication repair domain handler."""
...
class StateAdjudicationRepairHandler:
    """Concrete adapter for adjudicated state issue repairs."""

    name = "state_adjudication_repair"
    _surfaces = {RepairSurface.CHAPTER_TEXT, RepairSurface.CHAPTER_CONTRACTS}
    ...
    def supports(self, target: RepairTarget) -> bool:
        return target.domain == RepairDomain.STATE_ADJUDICATION and target.surface in self._surfaces
