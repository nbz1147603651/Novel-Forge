"""Guardrail repair domain handler."""
...
class GuardrailRepairHandler:
    """Concrete adapter for guardrail repairs that mutate chapter text."""

    name = "guardrail_repair"
    _surfaces = {RepairSurface.CHAPTER_TEXT, RepairSurface.CHAPTER_WINDOW}
    ...
    def supports(self, target: RepairTarget) -> bool:
        return target.domain == RepairDomain.GUARDRAIL and target.surface in self._surfaces
