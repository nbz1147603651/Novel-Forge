...
| `repair_strategy_diagnose.j2` | 修复策略诊断 | `REPAIR_STRATEGY_DIAGNOSE` |
...
| `humanize_paragraph_rewrite.j2` | AI 痕迹段落级改写 | `HUMANIZE_PARAGRAPH_REWRITE` |
| `knowledge_boundary_audit.j2` | 知识边界审计 | `KNOWLEDGE_BOUNDARY_AUDIT` |
| `repair_knowledge_boundary.j2` | 知识边界修复 | `REPAIR_KNOWLEDGE_BOUNDARY` |
| `extract_knowledge_deltas.j2` | 知识增量提取 | `EXTRACT_KNOWLEDGE_DELTAS` |
| `summary_drift_check.j2` | 摘要漂移检查 | `SUMMARY_DRIFT_CHECK` |
...
| `adjudicate_entity_references.j2` | 实体引用裁判 | `ADJUDICATE_ENTITY_REFERENCES` |
